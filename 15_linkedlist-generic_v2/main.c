...
int main(void)
{
   ...
   Student *s1 = st_create("Thiago", "12345678912", COURSE_BSI);
   Student *s2 = st_create("Giovana", "09876554321", COURSE_ECA);
   // st_print(s1);
   // st_print(s2);

   Professor *p1 = pr_create("Gabriel", "018123567687", DEPT_INF);
   Professor *p2 = pr_create("Suetter", "64938467201", DEPT_ENG);
   // pr_print(p1);
   // pr_print(p2);
